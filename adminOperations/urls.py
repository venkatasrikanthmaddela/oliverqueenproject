...
urlpatterns =  patterns("",
                        ...
                        url(r'new-projects-idea-request',NewProjectIdeaRequestsPage.as_view(),name="new-project-idea-requests"),
                         url(r'delete-new-project-idea-request$',NewProjectIdeaRequestsPage.as_view(), name="admin-dashboard")
                        )